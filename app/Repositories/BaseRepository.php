...
abstract class BaseRepository
{
    ...
    {
        return $this->make($with)->where($key, '=', $value)->latest($latest)->first();
    }
     ...
     * @return Builder[]|Collection
     */
    public function getManyInArray($key, $array, array $with = [], array $scopes = [])
    {
        $query = $this->make($with)->whereIn($key, $array);
